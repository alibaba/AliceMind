...
def create_optimizer(loss, init_lr, num_train_steps, num_warmup_steps, use_tpu, use_fp16=False):
  ...
  if use_fp16:
    loss_scale_manager = tf.contrib.mixed_precision.ExponentialUpdateLossScaleManager(init_loss_scale=2**32, incr_every_n_steps=400, decr_every_n_nan_or_inf=2, decr_ratio=0.8)
