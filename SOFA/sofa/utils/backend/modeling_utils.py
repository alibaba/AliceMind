    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        ...
        if pretrained_model_name_or_path is not None:
            ...
            if os.path.isdir(pretrained_model_name_or_path):
                ...
                raise RuntimeError(f"Only support local files or remote http(s) links.")
            ...
            try:
                ...
                resolved_archive_file = cached_path(
                    ...
                    extract_compressed_file=kwargs.get("extract_compressed_file", False)
                )
            ...
            if state_dict is None:
                try:
                    if os.path.isdir(resolved_archive_file):
                        resolved_archive_file = os.path.join(resolved_archive_file, WEIGHTS_NAME)
        ...
        if "extract_compressed_file" in model_kwargs:
            model_kwargs.pop("extract_compressed_file")
        # Instantiate model.
        if is_deepspeed_zero3_enabled():
            import deepspeed
