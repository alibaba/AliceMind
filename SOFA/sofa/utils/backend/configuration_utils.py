...
class PretrainedConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs.pop("xla_device", None) is not None:
            logger.warning(
                "The `xla_device` argument has been deprecated. It is ignored and you can "
        ...
        if kwargs.get("gradient_checkpointing", False):
            warnings.warn(
                ...
                "Using `model.gradient_checkpointing_enable()` instead, or if you are using the "
    ...
    def save_pretrained(self, save_directory: Union[str, os.PathLike], push_to_hub: bool = False, **kwargs):
        ...
        if push_to_hub:
            logger.warning(f"push_to_hub is deprecated in sofa.")
    ...
    def get_config_dict(
        ...
        if os.path.isfile(pretrained_model_name_or_path) or is_remote_url(pretrained_model_name_or_path):
            ...
            if os.path.isdir(pretrained_model_name_or_path):
                ...
                raise RuntimeError(f"Only local dir or file is supported.")
        ...
        try:
            ...
            resolved_config_file = cached_path(
                ...
                extract_compressed_file=kwargs.pop("extract_compressed_file", False)
            )
            if os.path.isdir(resolved_config_file):
                resolved_config_file = os.path.join(resolved_config_file, CONFIG_NAME)
            # Load config dict
