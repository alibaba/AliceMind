...
def xnli_preprocess(args):
  ...
  for split in ['test', 'dev']:
    ...
    removel_label = args.remove_test_label and (split == 'test')
    _preprocess_file(infile, args.output_dir, split, remove_label=removel_label)
...
if __name__ == "__main__":
  ...
  parser.add_argument("--process_all_langs", action='store_true',
                      help="process all langs for panx and udpos datasets")
  args = parser.parse_args()

  args.remove_test_label = False
