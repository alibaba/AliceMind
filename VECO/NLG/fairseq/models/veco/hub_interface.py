...
class VECOHubInterface(nn.Module):
    """A simple PyTorch Hub interface to VECO.

    Usage: https://github.com/pytorch/fairseq/tree/master/examples/VECO # todo: add example
    """
    ...
    def encode(self, sentence: str, *addl_sentences, no_separator=True) -> torch.LongTensor:
        ...
        requires leading spaces. For example::
            ...
            >>> veco.encode('Hello world').tolist()
            [0, 31414, 232, 2]
            >>> veco.encode(' world').tolist()
            [0, 232, 2]
            >>> veco.encode('world').tolist()
            [0, 8331, 2]
        """
