...
def add_preprocess_args(parser):
    ...
    group.add_argument("--resize-dict", metavar="FP",
                       help="resize the source and target dictionary according to training file")
    group.add_argument("--resized-dict-map", metavar="FP",
                       help="mapping file between original big vocabulary and resized small vocabulary")
