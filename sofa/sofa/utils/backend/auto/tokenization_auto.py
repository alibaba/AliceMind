...
if TYPE_CHECKING:
    ...
    TOKENIZER_MAPPING_NAMES = OrderedDict(
        [
            ("sbert", ("SbertTokenizer", "SbertTokenizerFast" if is_tokenizers_available() else None)),
            ("veco", ("VecoTokenizer", "VecoTokenizerFast" if is_tokenizers_available() else None)),
            ("palm", ("PalmTokenizer", "PalmTokenizerFast" if is_tokenizers_available() else None)),
        ]
    )
