# Copyright 2020 The HuggingFace Team, the AllenNLP library authors.
...
PT_TOKEN_CLASSIFICATION_SAMPLE = r"""
    ...
    ```python
    >>> from sofa.models import {processor_class}, {model_class}
    >>> import torch
...
def http_user_agent(user_agent: Union[Dict, str, None] = None) -> str:
    ...
    """
    ua = f"transformers/4.15.0; python/{sys.version.split()[0]}; session_id/{SESSION_ID}"
    if is_torch_available():
...
def get_from_cache(
    ...
    if isinstance(use_auth_token, str):
        ...
        logger.warning(f"use_auth_token type bool is deperacated.")
...
class PushToHubMixin:
    ...
    @classmethod
    def _push_to_hub(cls, repo, commit_message: Optional[str] = None) -> str:
        pass
