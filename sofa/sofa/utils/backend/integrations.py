...
class CometCallback(TrainerCallback):
    ...
    def setup(self, args, state, model):
        ...
        if state.is_world_process_zero:
            ...
            if comet_mode == "ONLINE":
                ...
                experiment.log_other("Created from", "sofa")
            ...
            if experiment is not None:
                experiment._set_model_graph(model, framework="sofa")
                experiment._log_parameters(args, prefix="args/", framework="sofa")
                if hasattr(model, "config"):
                    experiment._log_parameters(model.config, prefix="config/", framework="sofa")
    ...
    def on_log(self, args, state, control, model=None, logs=None, **kwargs):
        ...
        if state.is_world_process_zero:
            ...
            if experiment is not None:
                experiment._log_metrics(logs, step=state.global_step, epoch=state.epoch, framework="sofa")
