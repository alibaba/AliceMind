...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        if intermediate_mask is None:
            intermediate_mask = [None] * self.config.num_hidden_layers
        else:
...
class BertLayer(nn.Module):
    ...
    def forward(
        ...
        layer_output = apply_chunking_to_forward(
            self.feed_forward_chunk, intermediate_mask, self.chunk_size_feed_forward, self.seq_len_dim, attention_output
        )
    ...
    def feed_forward_chunk(self, intermediate_mask, attention_output):
        intermediate_output = self.intermediate(attention_output)
        if intermediate_mask is not None:
            intermediate_output = intermediate_output * intermediate_mask
...
def apply_chunking_to_forward(
    ...
    return forward_fn(intermediate_mask, *input_tensors)
