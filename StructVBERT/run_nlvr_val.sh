...
name=run-nlvr2-structvbert-base
...
CUDA_VISIBLE_DEVICES=5 PYTHONPATH=$PYTHONPATH:./ \
    ...
    --one_stream \
    --use_npz \
    --image_hdf5_file data/nlvr2_imgfeat/nlvr2_train_npz,data/nlvr2_imgfeat/nlvr2_valid_npz \
